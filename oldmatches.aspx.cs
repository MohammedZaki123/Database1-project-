...
{
    public partial class oldmatches : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
           ...
           ConnectionStrings["Milestone3"].ToString();
            ...
            SqlCommand oldmatches = new SqlCommand("Select * from alreadyPlayedMatches", conn);
            conn.Open();
            SqlDataReader rdr = oldmatches.ExecuteReader();
            ...
            oldmatchesGridView.DataSource = dt;
            oldmatchesGridView.DataBind();
            oldmatchesGridView.Visible = true;
        }
    }
}